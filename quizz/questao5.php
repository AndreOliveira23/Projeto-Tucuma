...
<?php
		...
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a quinta questão!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>		
	...
	<br>Há quanto tempo você acha que a floresta amazônica existe?<br>
	</div>
	</div>
	
	<div class="container som">
		<input type="radio" name="5" value="5a" required>
		A)55 milhões de anos<br>
		...
		E)110 milhões de anos<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Questão 06" id="botaoForm"> </br>
		</div>
	</div>	
