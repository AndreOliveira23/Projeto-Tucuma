...
<?php
		...
		echo "<b>Hello,".$_SESSION['nome'].", this is the last question!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<form action="i-resultado.php" method="post">
	<br>Why it is important to recycle everything that is possible?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="10" value="10a" required>
		A)Because recycling helps in the correct use of natural resources<br>
		<input type="radio" name="10" value="10b">
		B)Because yes<br>
		<input type="radio" name="10" value="10c">
		C)Because recycling is negative for everyone<br>
		<input type="radio" name="10" value="10d">
		D)You can't recycle anything<br>
		<input type="radio" name="10" value="10e">
		E)Recycling is not important<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Finish" id="botaoForm"> </br>
		</div>
	</div>
