...
<?php
		...
		session_start();
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a segunda questão!</b>";
		$_SESSION['certo']=0;
		$_SESSION['errado']=0;
		?>
<?php
...
?>
	...
	<br>Essa lata de lixo indica reciclagem de qual material?<br>
	</div>
	...
	<div class="container som">
		...
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Questão 03" id="botaoForm"> </br>
		</div>
	</div>
