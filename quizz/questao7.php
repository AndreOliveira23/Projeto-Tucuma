...
<?php
		...
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a sétima questão!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<br>Por que é importante preservar a floresta amazônica?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="7" value="7a" required>
		A)Porque ela é legal<br>
		<input type="radio" name="7" value="7b">
		B)Porque todo mundo fala dela<br>
		<input type="radio" name="7" value="7c">
		C)Porque ela é importante para a manutenção da atmosfera<br>
		...
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Questão 08" id="botaoForm"> </br>
		</div>
	</div>
