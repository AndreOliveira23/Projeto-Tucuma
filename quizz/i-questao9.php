...
<?php
		...
		echo "<b>Hello,".$_SESSION['nome'].", this is the ninth question!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<form action="i-questao10.php" method="post">
	<br>How many plant species are there in the Amazon<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="9" value="9a" required>
		A)About 10,000<br>
		<input type="radio" name="9" value="9b">
		B)About 50,000<br>
		<input type="radio" name="9" value="9c">
		C)More or less 100,000<br>
		<input type="radio" name="9" value="9d">
		D)Close to 200 millions<br>
		<input type="radio" name="9" value="9e">
		E)Just under 50<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Question 10" id="botaoForm"> </br>
		</div>
	</div>
