...
<?php
		...
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a última questão!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<br>Por que é importante reciclar tudo o que for possível?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="10" value="10a" required>
		A)Porque a reciclagem ajuda no uso correto dos recursos naturais<br>
		<input type="radio" name="10" value="10b">
		B)Porque sim<br>
		<input type="radio" name="10" value="10c">
		C)Porque a reciclagem é algo negativo para todo mundo<br>
		<input type="radio" name="10" value="10d">
		D)Não dá pra reciclar nada<br>
		<input type="radio" name="10" value="10e">
		E)Reciclar não é importante<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Finalizar" id="botaoForm"> </br>
		</div>
	</div>
