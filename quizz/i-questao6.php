...
<?php
		...
		echo "<b>Hello,".$_SESSION['nome'].", This is the sixth question!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<form action="i-questao7.php" method="post">
	<br>Of all the fauna in the world, how much do you think the Amazon shelters?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="6" value="6a" required>
		A)10% of all the fauna<br>
		<input type="radio" name="6" value="6b">
		B)20% of all the fauna<br>
		<input type="radio" name="6" value="6c">
		C)35% of all the fauna<br>
		<input type="radio" name="6" value="6d">
		D)80% of all the fauna<br>
		<input type="radio" name="6" value="6e">
		E)100% of all the fauna<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Question 07" id="botaoForm"> </br>
		</div>
	</div>
