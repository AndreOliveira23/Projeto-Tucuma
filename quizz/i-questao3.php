...
<?php
		...
		echo "<b>Hello,".$_SESSION['nome'].", This is the third question!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>
	...
	<br>The Amazon forest is present in how many states of Brazil?<br>
	</div>
	</div>
	...
	<div class="container som">
		...
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Question 04" id="botaoForm"> </br>
		</div>
	</div>
