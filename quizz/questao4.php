...
<?php
		...
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a quarta questão!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<br>Qual alternativa apresenta maneiras de economizar água?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="4" value="4a" required>
		A)Escovar os dentes com a torneira ligada e tomar banhos demorados <br>
		<input type="radio" name="4" value="4b">
		B)Lavar o carro com uma mangueira e usar a descarga excessivamente<br>
		<input type="radio" name="4" value="4c">
		C)Limpar a calçada lavando-a com mangueira e não prestar atenção em vazamentos<br>
		<input type="radio" name="4" value="4d">
		D)Manter a torneira fechada quando não estiver usando e Lavar roupas quando o cesto estiver cheio<br>
		<input type="radio" name="4" value="4e">
		E)Nenhuma das alternativas<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Questão 05" id="botaoForm"> </br>
		</div>
	</div>
