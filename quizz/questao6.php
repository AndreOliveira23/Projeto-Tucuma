...
<?php
		...
		echo "<b>Olá, ".$_SESSION['nome'].", Esta é a sexta questão!</b>";
		$_SESSION['certo'];
		$_SESSION['errado'];
		?>
<?php
...
?>			
	...
	<br>De todas a fauna presente no mundo, quanto você acha que a Amazônia abriga?<br>
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="6" value="6a" required>
		A)10% de toda a fauna<br>
		<input type="radio" name="6" value="6b">
		B)20% de toda a fauna<br>
		<input type="radio" name="6" value="6c">
		C)35% de toda a fauna<br>
		<input type="radio" name="6" value="6d">
		D)80% de toda fauna<br>
		<input type="radio" name="6" value="6e">
		E)100% de toda a fauna<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Questão 07" id="botaoForm"> </br>
		</div>
	</div>
