...
<?php
		session_start();
		echo "<b>Hello,".$_SESSION['nome'].",This is the first question!</b>";
		$_SESSION['certo']=0;
		$_SESSION['errado']=0;
		?>
	<form action="i-questao2.php" method="post">
	<br>Which fruit is this?<br>
	<img src="guarana1.png" width="350px" height="270px" class="mt-3 mb-4">
	</div>
	</div>

	<div class="container som">
		<input type="radio" name="1" value="1a">
		A)Cherry tomato<br>
		<input type="radio" name="1" value="1b">
		B)Blackberry<br>
		<input type="radio" name="1" value="1c">
		C)Guarana<br>
		<input type="radio" name="1" value="1d" required>
		D)Annatto<br>
		<input type="radio" name="1" value="1e" required>
		E)Tucuma<br>
		<div class="formularios mt-5 mb-5">
			<input type="submit" value="Question 02" id="botaoForm"> </br>
		</div>
	</div>
