...
<head>
	...
	<meta http-equiv="refresh" content="5; http://localhost/tucuma/som/ranking.php">
</head>
<body onload="start();">
...
//inicia a sessão
	...
	include_once('conexao.php'); 
		...
		echo "Olá,".$_SESSION['nome'].", Este foi seu resultado: <br><br>";
			...
			$questao5=$_POST['5'];
				//verifica se está correto ou incorreto
				if($questao5=='5b'){
		...
		$nome = $_SESSION['nome'];
		$id = $_SESSION['ID'];
		   //modifica e armazena as informações no banco de dados
			$update = "Update JOGADORES set RECORDE_JOGADOR = '$certas' where ID_JOGADOR = '$id'";
			//verifica se a conexão está funcioando		   
